...
class DashboardController extends Controller
{
    ...
    { 
        ...
        if(Auth::user()->hasRole('admin'))
        {
            ...
            return view('front-end.dashboard.admin-dashboard', ['users' => $count]);
        }
        elseif(Auth::user()->hasRole('teacher'))
        {
            ...
            // dd($subject);
            return view('front-end.dashboard.teacher-dashboard', ['subjects' => $subject]);
        }
        elseif(Auth::user()->hasRole('student'))
        {
            ...
            if ($count_existence > 0)
            {
                ...
                return view('front-end.dashboard.teacher-dashboard', ['progress' => $progress]);
            }
            $progress = null;
            return view('front-end.dashboard.teacher-dashboard', ['progress' => $progress]);
        }
