                       ...
                       <div tabindex="0" aria-label="card 1" style="width: 800px " class="bg-yellow-200 focus:outline-none lg:w-12/12 lg:mr-7 lg:mb-0 mb-7 bg-white p-6 shadow-md border-t-1  rounded">
                           <div class="flex items-center border-b border-gray-200 pb-6 ">
                               <div class="flex items-start justify-between w-full ">
                                   <div class="pl-3 w-full pr-2">
                                       <p tabindex="0" class="focus:outline-none text-md font-small leading-3 text-gray-800 ">{{$loop->iteration}}.  {{ $test->question }}</p>
                                  ...
                                  <!-- button  -->
                                       @if (Auth::user()->hasRole('teacher'))
                                        ...
                                        <form action="{{ route('delete-question-teacher', $test->id) }}" method="POST">   
                                           
                                            @csrf
                                            @method('DELETE')      
                                            <button type="submit" class="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-600">Delete</button>
                                        </form>

                                        <!-- <a href="{{ route('delete-question-teacher', $test->id) }}" class="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-600">
                                            Delete 
                                        </a> -->
                           ...
                           <div class="flex flex-col grid-cols-12">
                                ...
                                <label class="inline-flex items-center mt-3 w-full">
                                  ...
                                  <input type="radio" class=" h-5 w-5" value="{{ $choices }}">
