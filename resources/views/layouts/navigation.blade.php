<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                  ...
                  <div class="flex flex-col w-full md:w-72 text-white flex-shrink-0" style="background:#0f0f0f ">
                    <div class="flex-shrink-0 px-8 py-4 flex flex-row items-center justify-between">
                      <a href="#" class="text-lg flex items-center gap-2 font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">
                          <img src="{{ asset('images/dash-logo.gif') }}" class="h-8 w-8" alt="">
                          <span class="text-2xl font-bold text-white">GPC</span>
                        </a>
                    </div>
                    <nav class="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto">
                       ...
                       {{-- <x-nav-link :href="route('task')" :active="request()->routeIs('task')">
                        ...
                        <x-nav-link :href="route('files')" :active="request()->routeIs('files')">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="transform: ;msFilter:;"><path d="M6 22h12a2 2 0 0 0 2-2V8l-6-6H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2zm7-18 5 5h-5V4zm-4.5 7a1.5 1.5 0 1 1-.001 3.001A1.5 1.5 0 0 1 8.5 11zm.5 5 1.597 1.363L13 13l4 6H7l2-3z"></path></svg>
                            {{ __('File ') }}
                        </x-nav-link> --}}
                        @endif
                        ...
                        <x-nav-link :href="route('accounts')" :active="request()->routeIs('accounts')">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="transform: ;msFilter:;"><path d="M20 2H8a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zm-6 2.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zM19 15H9v-.25C9 12.901 11.254 11 14 11s5 1.901 5 3.75V15z"></path><path d="M4 8H2v12c0 1.103.897 2 2 2h12v-2H4V8z"></path></svg>
                            {{ __('Accounts') }}
                        </x-nav-link>
                        @endif
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="transform: ;msFilter:;"><path d="m5.705 3.71-1.41-1.42C1 5.563 1 7.935 1 11h1l1-.063C3 8.009 3 6.396 5.705 3.71zm13.999-1.42-1.408 1.42C21 6.396 21 8.009 21 11l2-.063c0-3.002 0-5.374-3.296-8.647zM12 22a2.98 2.98 0 0 0 2.818-2H9.182A2.98 2.98 0 0 0 12 22zm7-7.414V10c0-3.217-2.185-5.927-5.145-6.742C13.562 2.52 12.846 2 12 2s-1.562.52-1.855 1.258C7.184 4.073 5 6.783 5 10v4.586l-1.707 1.707A.996.996 0 0 0 3 17v1a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-1a.996.996 0 0 0-.293-.707L19 14.586z"></path></svg>
                            {{ __('Notifications') }}
                            <div class="py-1 px-3 bg-red-700 rounded text-gray-300 flex items-center justify-end text-xs">25</div>
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden bg-white right-0 left-0 md:hidden fixed z-50 h-screen">
