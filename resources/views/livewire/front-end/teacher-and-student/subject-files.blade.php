                           ...
                           <div class="flex items-center border-b border-gray-200 pb-6">
                               <div class="flex items-start justify-between w-full">
                                   <div class="pl-3 w-full">
                                       <p tabindex="0" class="focus:outline-none text-xl font-medium leading-5 text-gray-800">{{ $file->name }}</p>
                                       <p tabindex="0" class="focus:outline-none text-sm leading-normal pt-2 text-gray-500">{{ $file->created_at }}</p>
                                   </div>
                                   @if (Auth::user()->hasRole('teacher'))
                                   <button wire:click="delete({{ $file->id }} )" class="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-600">
                                        Delete 
                                    </button>
                                    @endif
                               </div>
                ...
                <div class="flex items-center justify-center h-full w-full">
                    <div class="bg-white rounded-md shadow fixed overflow-y-auto sm:h-auto w-10/12 md:w-8/12 lg:w-1/2 2xl:w-2/5">
                        <div class="bg-gray-100 rounded-tl-md rounded-tr-md px-4 md:px-8 md:py-4 py-7 flex items-center justify-between">
                            ...
                            <p class="text-base font-semibold">Add File</p>
                        ...
                        <div class="px-4 md:px-10 pt-6 md:pt-12 md:pb-4 pb-7">
                            ...
                            <form class="" action="" wire:submit.prevent="create">
                              ...
                              <div class="grid grid-cols-1 mx-7 mt-4">
