...
<h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            @forelse ($user->notifications as $notification)
                <div class="w-full p-3 mt-8 bg-white rounded flex">
                        ...
                        <div class="pl-3">
                            <p tabindex="0" class="focus:outline-none text-sm leading-none"><span class="text-indigo-700">James Doe</span> favourited an <span class="text-indigo-700">{{ $notification->data['name']}}</span></p>
